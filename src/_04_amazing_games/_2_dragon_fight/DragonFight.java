...
int dragonAttack = 0;
		...
		while (true) {
			...
			// THE PLAYER ATTACKS THE DRAGON
				...
				// or a kick
String attack = JOptionPane.showInputDialog("Do you want yell or kick the dragon?");	
...
if (dragonHealth <= 0) {
	dragonLost ();
				...
				// 		dragon have left.
String message = "Player health: "+ playerHealth + ", Dragon health: " + dragonHealth;
...
JOptionPane.showMessageDialog(null, "You won and have a ton of gold congrats!");
		System.exit(0);   //This code ends the program
	}
